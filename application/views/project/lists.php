	...
	<div class="col s12 m12">
		...
		<li class="collection-header" style="background:transparent;padding:0;">
			<div style="z-index: 2147483647; position: fixed; top: 15px; left: calc(100% - 500px);">
					...
					<a data-delay="50" data-tooltip="Previous To Production Rates" class="btn-floating tooltipped white" style="float: right;margin-left:10px;" href="<?php echo SITE_ROOT."/project/production_rates?project_id=".$_REQUEST['project_id']; ?>">
...
$(function(){
 $('#listsoff').addClass('active');
 $("#headingSearchtitle").html("Lists");
});
$(function () {
   $.fn.fixMe = function() {
