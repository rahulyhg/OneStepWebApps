	...
	<div class="col s12 m12">
		...
		<li class="collection-header" style="background:transparent;padding:0;">
			<div style="z-index: 2147483647; position: fixed; top: 15px; left: calc(100% - 470px);">
					<a data-delay="50" data-tooltip="Next To Pricing" class="btn-floating tooltipped white" style="float: right;margin-left:10px;" href="<?php echo SITE_ROOT."/project/external_pricing?project_id=".$_REQUEST['project_id']; ?>">
					...
					<a data-delay="50" data-tooltip="Previous To Estimate" class="btn-floating tooltipped white" style="float: right;margin-left:10px;" href="<?php echo SITE_ROOT."/project/externalestimate?project_id=".$_REQUEST['project_id']; ?>">
...
$(document).ready(function() {
    var table = $('#data-table-row-grouping').DataTable({
		...
		"processing": true,
        "serverSide": true,
		"ajax": "<?= BASEPATH."/project/listextproject?project_id=".$_REQUEST['project_id']; ?>",
		columnDefs: [
...
function deleteData(id)
{
	...
	if (r==true)
	{
		window.location.href="<?=SITE_ROOT;?>/project/deleteextproject?id="+id+"&project_id=<?php echo $_REQUEST['project_id']; ?>";
	}
}
$(function(){
 $('#extproject').addClass('active');
 $("#headingSearchtitle").html("Exterior Project");
