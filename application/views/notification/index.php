...
if (!$access->hasPrivilege("ManageNotification"))
{
...
<style type="text/css">
	...
	pre, code {
        ...
        ?>
        <div class="container">
            <div class="fl_window" style="display:none;">
            ...
            <form class="pure-form pure-form-stacked" method="get">
                <fieldset>
                    ...
                    <label for="include_image1" class="pure-checkbox" style="display:none">
                        <input id="include_image1" name="include_image" type="checkbox"> Include image
                    </label>
                    <input type="hidden" name="push_type" value="topic"/>
                    <button style="margin-top:20px;" type="submit" class="pure-button pure-button-primary btn_send">Send to Topic</button>
                </fieldset>
            </form>
        </div>
<script>
