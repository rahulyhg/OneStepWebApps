...
window.webcam = {
	...
	swf_url: 'http://vettreefiles.com/js/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://vettreefiles.com/js/shutter.mp3', // URI to shutter.mp3 sound
